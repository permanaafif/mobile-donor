        ...
        holder.foto_profile.setOnClickListener {
            ...
            if (id_pendonor != balasComment.id_pendonor){
                if (id_pendonor_now != balasComment.id_pendonor){
                    if (balasComment.gambar != "null"){
                        showAlertGambarProfile(holder.itemView.context,path_foto_profile,balasComment.nama,balasComment.id_pendonor)
                    }

                    if (balasComment.gambar == "null" || balasComment.gambar.isNullOrEmpty()){
                        showAlertGambarProfile(holder.itemView.context,"null",balasComment.nama,balasComment.id_pendonor)
                    }
                }
            }
        }
